...
const MENU_SECTIONS = [
  {
    title: "Account",
    items: [
      { icon: "person-outline", label: "Edit Profile", color: "#4FD1C5" }, // primary
      { icon: "shield-checkmark-outline", label: "Privacy & Security", color: "#2FA89D" }, // primary dark
      { icon: "notifications-outline", label: "Notifications", value: "On", color: "#7EE6DC" }, // primary light
    ],
  },
  {
    title: "Preferences",
    items: [
      ...
      { icon: "language-outline", label: "Language", value: "English", color: "#6B7280" }, // muted
  ...
  },
  {
    title: "Support",
    items: [
      { icon: "help-circle-outline", label: "Help Center", color: "#6B7280" },
...
const ProfileTab = () => {
  ...
  return (
    ...
    >
      ...
      {/* LOG OUT */}
      <Pressable
        className="mx-5 mt-8 bg-danger/10 rounded-2xl py-4 items-center active:opacity-70 border border-danger/20"
        onPress={() => signOut()}
      >
        <View className="flex-row items-center">
          <Ionicons name="log-out-outline" size={20} color="#EF4444" />
          <Text className="ml-2 text-danger font-semibold">Log Out</Text>
        </View>
      </Pressable>
    </ScrollView>
  );
